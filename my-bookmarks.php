...
function acc_register_bookmark() {
    ...
    $labels = array(
        'name' => _x( 'Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'singular_name' => _x( 'Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'add_new' => _x( 'Add New Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'add_new_item' => _x( 'Add New Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'edit_item' => _x( 'Edit Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'new_item' => _x( 'New Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'view_item' => _x( 'View Bookmark', MY_BOOKMARKS_POST_TYPE ),
        'search_items' => _x( 'Search Bookmarks', MY_BOOKMARKS_POST_TYPE ),
        'not_found' => _x( 'No bookmarks found', MY_BOOKMARKS_POST_TYPE ),
        'not_found_in_trash' => _x( 'No bookmarks found in Trash', MY_BOOKMARKS_POST_TYPE ),
        'parent_item_colon' => _x( 'Parent Position:', MY_BOOKMARKS_POST_TYPE ),
        'menu_name' => _x( 'Bookmarks', MY_BOOKMARKS_POST_TYPE ),
    );
...
function acc_bookmark_template( $single_template) {
    ...
    global $post;
    if ($post->post_type == MY_BOOKMARKS_POST_TYPE) {
